...
# I added multiple levels,several endings,and extra choices to make the game intresting and creative.

print("Welcome to the Hidden Blessing Adventure Game!")
print("Your father gives you a choice: BIBLE or MONEY.")
# LEVEL 1
choice1 = input ("Which do you choose? (BIBLE or MONEY): ")
...
if choice1 == "bible":
    ...
    # LEVEL 2 
    choice2 = input("Which do you chose? (LETTER or CASH): ")
